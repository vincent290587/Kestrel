...
Not started yet: the actual `ant` west module integration, and the BLE central profile rewrite (`ble_cp_c`, `ble_lns_c`, `ble_komoot_c` against Zephyr's Bluetooth host API).
