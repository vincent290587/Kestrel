...
public:
	...
	/* Sets the zoom level directly, for callers that want a fixed
	 * value rather than driving it via increaseZoom()/decreaseZoom()
	 * (e.g. the map renderer's constant-zoom mode -- see
	 * docs/maps_feasibility.md phased plan). */
