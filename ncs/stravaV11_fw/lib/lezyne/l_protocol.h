/*
 * Ported unmodified (just the include guard renamed) from stravaV10's
 * rf/l_protocol.h, feature/lez branch -- the wire-protocol enum contract
 * for impersonating a real Lezyne GPS computer over BLE NUS, reverse-
 * engineered from the real Lezyne "GPS Ally" Android app (see
 * source/parsers/SequenceUnpacker.h's decompiled-source comments in
 * stravaV10 for how). See CLAUDE.md/todo.md for the full port scope.
 */

#ifndef L_PROTOCOL_H_
#define L_PROTOCOL_H_
